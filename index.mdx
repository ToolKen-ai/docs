---
title: "Introduction"
description: "Toolken is a managed LLM gateway. Change one base URL to get cost per agent, feature, and customer, with budgets and rate limits, and nothing to host."
icon: "bolt"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Budgets & rate limits" icon="shield-check">Caps enforced at the edge, before a request ever reaches your provider.</Card>
